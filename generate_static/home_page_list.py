...
def render_list_module():
    ...
    for cards in row:
        if n%3 == 0:
            col1+='<li><a href="%(wbroot)s/modules/module_card_id%(id)s_serial_num%(serial)s.html"> %(serial)s </h4></li>' %{'wbroot':webroot, 'serial':cards[0], 'id':cards[1]}
        if n%3 == 1:
            col2+='<li><a href="%(wbroot)s/modules/module_card_id%(id)s_serial_num%(serial)s.html"> %(serial)s </h4></li>' %{'wbroot':webroot, 'serial':cards[0], 'id':cards[1]}
        if n%3 == 2:
            col3+='<li><a href="%(wbroot)s/modules/module_card_id%(id)s_serial_num%(serial)s.html"> %(serial)s </h4></li>' %{'wbroot':webroot, 'serial':cards[0], 'id':cards[1]}
        n += 1
